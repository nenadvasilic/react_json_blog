...
import {MDBIcon, MDBContainer, MDBRow, MDBCol, MDBCard, MDBCardText,
  MDBCardTitle, MDBCardBody, MDBCardImage, MDBTypography} from 'mdb-react-ui-kit';
...
`http://localhost:5000/blogs?category=${response.data.category}&_start=0&_end=3`);
  ...
  return (
    <MDBContainer style={{border: '1px solid #d1ebe8'}}>
      ...
      <img src={blog && blog.imageUrl} className='img-fluid rounded'
          alt={blog && blog.title} style={{width: '100%', maxHeight: '600px'}} />
      <div style={{marginTop: '20px'}}>
        <div style={{height: '43px', background: '#f6f6f6'}}>
          <MDBIcon style={{float: 'left'}} className="mt-3"
